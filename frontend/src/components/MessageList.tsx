      ...
      <div className="max-w-4xl mx-auto px-4 py-6 space-y-4">
        {messages.length === 0 && (
          <div className="flex flex-col items-center justify-center h-full text-center px-4">
            <div className="w-16 h-16 mb-4 bg-kp-green-light rounded-full flex items-center justify-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-8 h-8 text-kp-green"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                aria-hidden="true"
          ...
          >
            <div
              className={`max-w-xl px-4 py-3 rounded-2xl ${
                message.role === "user"
                  ? "bg-kp-green text-white rounded-tr-sm"
            ...
            >
              ...
              <div
                className={`text-xs mt-2 ${
                  message.role === "user" ? "text-kp-green-light" : "text-gray-400"
                }`}
              >
